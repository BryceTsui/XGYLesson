    ...
    >
      <template v-if="!loading">
        <header class="aui-header">
          ...
          <div class="aui-header__bd">
            ...
            <el-menu class="aui-header__menu aui-header__menu--right" mode="horizontal">
              <el-menu-item index="4" @click="groupMailVisible=true">
                <svg class="icon-svg aui-header__icon-menu" aria-hidden="true"><use xlink:href= "#icon-mail"></use></svg>
              </el-menu-item>
        ...
        <aside class="aui-aside">
          <div class="aui-aside__inner">
            <el-menu
              ...
              <el-menu-item index="home" @click="gotoMainPage()">
              ...
              <el-menu-item index="chart" @click="gotoPageHandle('@@path/pages/icon.html')">
              ...
              <main class="aui-page-main">
                <el-row :gutter="15">
                  <el-col :span="16">
                        ...
                        <div class="aui-panel__bd">
                          <el-tabs class="aui-tabs aui-tabs--flex" v-model="indexNoticeTabsActive">
                            ...
                            <el-tab-pane label="成绩公告" name="1">
                              ...
                              <p class="index-notice__more"><a @click="addBroadcast0()">添加</a></p>
                            ...
                            <el-tab-pane label="实验通知" name="2">
                              ...
                              <p class="index-notice__more"><a  @click="addBroadcast1()">添加</a></p>
                            ...
                            <el-tab-pane label="作业通告" name="3">
                              ...
                              <p class="index-notice__more"><a @click="addBroadcast2()">添加</a></p>
                            ...
                            <el-tab-pane label="其他" name="4">
                              ...
                              <p class="index-notice__more" ><a @click="addBroadcast3()">添加</a></p>
                    ...
                    <el-dialog
                      title="添加公告"
                      :visible.sync="addBroadcastVisible"
                      width="50%"
                    >
                      <el-form :label-position="newBroadcat" label-width="80px" :model="formLabelAlign">
                        <el-form-item label="名称">
                          <el-input v-model="newBroadcat.title"></el-input>
                        </el-form-item>
                        <el-form-item label="公告内容">
                          <el-input v-model="newBroadcat.content"></el-input>
                        </el-form-item>
                      </el-form>

                      <span slot="footer" class="dialog-footer">
                            <el-button @click="addBroadcastVisible= false">取消</el-button>
                            <el-button type="primary" @click="submitBroadcast">上传 </el-button>
                             </span>
                    </el-dialog>
                    ...
                    <el-dialog
                      title="作业详情"
                      :visible.sync="addResourseVisible"
                      width="50%"
                    >
                      ...
                      <span slot="footer" class="dialog-footer">
                            <el-button @click="addResourseVisible = false">取消</el-button>
                            <el-button type="primary" @click="submitResourse">上传 </el-button>
                             </span>
                    </el-dialog>

                    <el-dialog
                      title="群发邮件"
                      :visible.sync="groupMailVisible"
                      width="50%"
                    >
                      <el-form :label-position="groupMail" label-width="80px" :model="formLabelAlign">
                        <el-form-item label="标题">
                          <el-input v-model="groupMail.title"></el-input>
                        </el-form-item>
                        <el-form-item label="邮件正文">
                          <el-input v-model="groupMail.content"></el-input>
                        </el-form-item>
                      </el-form>

                      <span slot="footer" class="dialog-footer">
                            <el-button @click="groupMailVisible= false">取消</el-button>
                            <el-button type="primary" @click="sendGroupMail">发送 </el-button>
                             </span>
                    </el-dialog>
                        ...
                        <div class="aui-panel__bd">
                          <el-tabs class="aui-tabs" v-model="indexPersonalTabsActive">
                            <el-tab-pane class="index-product" label=" 课件" name="1">
                              ...
                              <p class="index-notice__more" ><a @click="addResourseVisible=true">添加课件</a></p>

                            </el-tab-pane>
                            <el-tab-pane class="index-consume" label="作业" name="2">
                                <div v-for="item in CourseDetail.homeworks">
                                  <ul class="index-notice__list" >
                                    <li><a :href="'http://localhost:8080/j2ee/file/homework/downlaodall?courseid='+CourseDetail.id+'&homeworkid='+item.id">【作业】{{item.name}}</a></li>
                                  </ul>
                                </div>
                              <p class="index-notice__more" ><a @click="addHomeworkDialogVisible=true">添加作业</a></p>
                            </el-tab-pane>
                            ...
                            <el-dialog
                              ...
                              width="50%"
                            >
                              <el-form :label-position="newHomework" label-width="80px" :model="formLabelAlign">
                                <el-form-item label="标题">
                                  ...
                                  <el-form-item label="作业时间">
                                    <el-col :span="11">
                                      <el-form-item prop="dateStart">
                                        <el-date-picker value-format="yyyy-MM-dd" type="date" placeholder="起始日期" v-model="newHomework.starttime" style="width: 100%;"></el-date-picker>
                                      </el-form-item>
                                    </el-col>
                                    <el-col class="line" :span="2">-</el-col>
                                    <el-col :span="11">
                                      <el-form-item prop="dateEnd">
                                        <el-date-picker value-format="yyyy-MM-dd" type="date" placeholder="截止日期" v-model="newHomework.endtime" style="width: 100%;"></el-date-picker>
                                      </el-form-item>
                                    </el-col>
                                  </el-form-item>
                            ...
                            <el-button type="primary" @click="submitNewHomework">上传 </el-button>
                             </span>
                            </el-dialog>
                      ...
                      <div class="aui-panel index-notice">
                        <div class="aui-panel index-undo">
                          ...
                          <div class="aui-panel__bd">
                            ...
                            <img src="../images/shangchuan.png" style="width: 70%;height: 70%;padding-left: 30%" @click="uploadFile">

                            <input @click="uploadScore($event)" type="file" id="upload_score" multiple style="display: none"/>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <footer class="aui-footer">
          <p><a target="_blank">MyCourse</a>j2ee XGY</p>
        </footer>
  ...
  export default {
    ...
    data () {
      return {
        ...
        currentBroadCast:{},
        addResourseVisible:false,
        broadcastDialogVisible:false,
        addBroadcastVisible:false,
        list:[],
    ...
    methods: {
      ...
      sendGroupMail(){
        ...
        xmlhttp.onreadystatechange = function () {
          if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            _this.groupMailVisible=false

          }
        }
        let formData = new FormData()
        formData.append('content',this.groupMail.content)
        formData.append('title',this.groupMail.title )
        formData.append('courseid',localStorage.getItem("courseid") )

        xmlhttp.open('POST', 'http://localhost:8080/j2ee/course/send/group', true)
        xmlhttp.send(formData)
      },

      uploadFile(){

        document.getElementById('upload_score').click()
      ...
      uploadScore(el){
        ...
        for (let i = 0; i < files.length; i++) {
          if (files[i].type != '') {
            ...
            formData.append('courseid',localStorage.getItem("courseid") )
            formData.append('ispublic',this.publicScore )
            xmlhttp.open('POST', 'http://localhost:8080/j2ee/course/uploadscore', true)
            xmlhttp.send(formData)
      ...
      submitNewHomework(){
        ...
        xmlhttp.onreadystatechange = function () {
          if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            _this.addHomeworkDialogVisible = false;
          }
        }
        ...
        xmlhttp.open('POST', 'http://localhost:8080/j2ee/course/create/homework', true)
        xmlhttp.setRequestHeader('Content-type', 'application/json; charset=utf-8')
        xmlhttp.send(JSON.stringify(homework))
      ...
      submitResourse(){
        ...
        xmlhttp.onreadystatechange = function () {
          if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            _this.addResourseVisible=false;
          }
        }
        let formData = new FormData()
        ...
        formData.append('courseid',localStorage.getItem("courseid") )
        xmlhttp.open('POST', 'http://localhost:8080/j2ee/file/upload', true)
        xmlhttp.send(formData)
      },
      imgClear () {
      ...
      submitBroadcast(){
        ...
        xmlhttp.onreadystatechange = function () {
          if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            _this.addBroadcastVisible = false;
            if(_this.type==='score'){
              _this.CourseDetail.broadcast0.push(JSON.parse(xmlhttp.responseText))
            }
            else if(_this.type==='experiment'){
              _this.CourseDetail.broadcast1.push(JSON.parse(xmlhttp.responseText))
            }
            else if(_this.type==='homework'){
              _this.CourseDetail.broadcast2.push(JSON.parse(xmlhttp.responseText))
            }
            else{
              _this.CourseDetail.broadcast3.push(JSON.parse(xmlhttp.responseText))
            }
          }
        }
        let formData = new FormData()
        formData.append('courseid', localStorage.getItem("courseid"))
        formData.append('title', this.newBroadcat.title)
        formData.append('content', this.newBroadcat.content)
        formData.append('type',this.type)
        xmlhttp.open('POST', 'http://localhost:8080/j2ee/broadcast/create', true)
        xmlhttp.send(formData)
