    ...
    <aside class="aui-aside">
      <div class="aui-aside__inner">
        <el-menu
          ...
          <el-menu-item index="home" @click="showMain">
                  ...
                  <el-row :gutter="15">
                    ...
                    <el-col :span="7">
                      <div class="aui-panel index-undo">
                        <div class="aui-panel__hd">课程统计</div>
                        <div class="aui-panel__bd">
                          <a class="index-block index-block--level">
                            <div class="index-block__hd">正在进行</div>
                            <div class="index-block__bd"><em class="index-block__value">{{personalCenterInfo.course_ing}}</em></div>
                          </a>
                          <a class="index-block index-block--level">
                            <div class="index-block__hd">已结束</div>
                            <div class="index-block__bd"><em class="index-block__value">{{personalCenterInfo.course_ed}}</em></div>
                          </a>
                          <a class="index-block index-block--level">
                            <div class="index-block__hd">未开始</div>
                            <div class="index-block__bd"><em class="index-block__value">{{personalCenterInfo.course_future}}</em></div>
                          </a>
                        </div>
                      </div>
                    </el-col>
                ...
                <div class="index-section">
                  <div class="aui-panel index-recent">
                    <div class="aui-panel__hd clearfix">
                      ...
                      <a  class="f-right fz-xs">
                        <span class="va-middle" @click="getAllCourse">添加课程</span>

                        <el-dialog title="添加课程" :visible.sync="addCourseVisible">
                          <el-collapse v-model="activeNames2" @change="handleChange">

                            <div  v-for="(array,key) of allpublishedCourse" :key="key">
                              <el-collapse-item v-bind:title="key" v-bind:name="key">
                                <div class="aui-panel__bd">
                                  <el-row :gutter="15">
                                    <div  v-for="item in array" >
                                      <div @click="addCourse(item.id)">
                                      <el-col :span="20">
                                        <a class="index-block index-block--level">
                                          <div class="index-block__bd">{{item.name}}&nbsp;&nbsp;&nbsp;&nbsp;主讲人:{{item.teachername}}</div>
                                        </a>
                                      </el-col>
                                      </div>
                                    </div>
                        ...
                        <el-dialog title="确认添加" :visible.sync="ensureAddCourse">

                          <span>您确认添加该课程吗？</span>
                          <el-button @click="saveAddCourse">确认</el-button>
                          <el-button @click="ensureAddCourse=false">取消</el-button>
                        </el-dialog>
                    ...
                    <div class="aui-panel__bd">
                      <el-tabs class="aui-tabs aui-tabs--flex" v-model="indexNoticeTabsActive">
                        ...
                        <el-tab-pane label="成绩公告" name="1">
                            <div v-for="item in personalCenterInfo.broadcast0.slice(0,3)">
                        ...
                        <el-tab-pane label="实验通知" name="2">
                          <div v-for="item in personalCenterInfo.broadcast1.slice(0,3)">
                        ...
                        <el-tab-pane label="作业通告" name="3">
                          <div v-for="item in personalCenterInfo.broadcast2.slice(0,3)">
                        ...
                        <el-tab-pane label="其他" name="4">
                          <div v-for="item in personalCenterInfo.broadcast3.slice(0,3)">
